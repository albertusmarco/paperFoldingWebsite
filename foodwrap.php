...
<body><section class="engine"><a href="https://mobirise.info/g">build your own site</a></section><section class="features12 cid-reLVq7k6e4" id="features12-2q">
        ...
        <div class="media-container-row pt-5">
            <div class="block-content align-right">
                ...
                <div class="card pl-3 pr-3 pb-5">
                    ...
                    <div class="card-box">
                        <p class="mbr-text mbr-section-text mbr-fonts-style display-7">Food Grade Paper (Grease Resistance)&nbsp;</p>
                    </div>
                </div>
            </div>

            <div class="mbr-figure" style="width: 34%;">
                <img src="assets/images/food-wrap-fix-626x626.png" alt="Mobirise" title="">
            </div>

      ...
      <nav class="navbar navbar-expand beta-menu navbar-dropdown align-items-center navbar-fixed-top navbar-toggleable-sm">
          ...
          <div class="menu-logo">
              <div class="navbar-brand">
                  ...
                  <span class="navbar-caption-wrap"><a class="navbar-caption text-white display-5" href="index.html">SENDWISH</a></span>
              </div>
          </div>
      ...
      <div class="container">
        <div class="container">
          ...
          <div class="media-container-column mbr-white col-lg-8 col-md-10 ml-auto">
              <h1 class="mbr-section-title mbr-bold pb-3 mbr-fonts-style">BOX CUSTOMIZE</h1>
              <div id="custom" align="left">

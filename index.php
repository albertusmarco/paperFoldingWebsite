...
<section class="engine"><a href="https://mobirise.info/u">bootstrap html templates</a></section><section class="header10 cid-rbkq4YRq2S mbr-fullscreen mbr-parallax-background" id="header10-3">
    ...
    <div class="container">
        <div class="media-container-column mbr-white col-lg-8 col-md-10 ml-auto">
            ...
            <div class="mbr-section-btn align-right"><a class="btn btn-md btn-primary-outline display-4" href="index.html#features18-k">TUTORIAL</a>
...
<section class="mbr-section article content1 cid-rblls8eMxl" id="content1-m">
    ...
    <div class="container">
        <div class="media-container-row">
            <div class="mbr-text col-12 col-md-8 mbr-fonts-style display-5">2. Choose the material</div>
        </div>
    </div>
</section>
    ...
    <div class="container">
        <div class="media-container-row">
            <div class="card p-3 col-12 col-md-6 col-lg-4">
                <div class="card-wrapper">
                    <div class="card-img">
                        <img src="assets/images/duplex-paper-1484110658-2680787-450x450.jpg" alt="Mobirise" title="">
                    </div>
                    <div class="card-box">
                        <h4 class="card-title mbr-fonts-style display-7">
                            Duplex</h4>
...
<section class="mbr-section article content1 cid-rblmrLHJ4T" id="content1-o">
    ...
    <div class="container">
        <div class="media-container-row">
            <div class="mbr-text col-12 col-md-8 mbr-fonts-style display-5">3. Start customizing ;)</div>
        </div>
    </div>
</section>
        ...
        <div class="media-container-row container pt-5 mt-2">
            ...
            <div class="col-12 col-md-6 mb-4 col-lg-3">
                <div class="card flip-card p-5 align-center">
                    <div class="card-front card_cont">
                        <img src="assets/images/template-porto-01-2-480x334.jpg" alt="Mobirise" title="">
                    </div>
                    <div class="card_back card_cont">
                        ...
                        <p class="mbr-text mbr-fonts-style display-7">
                            <br>Bang! Packaging &amp; Brand Design
                        </p>
                    </div>
                </div>
            </div>
            ...
            <div class="col-12 col-md-6 mb-4 col-lg-3">
                ...
                <div class="card flip-card p-5 align-center">
                    ...
                    <div class="card_back card_cont">
                        <h4 class="card-title py-2 mbr-fonts-style display-5">The Claire</h4>
                        <p class="mbr-text mbr-fonts-style display-7">
                            <br>The Claire Packaging &amp; Brand Design</p>
                    </div>
                </div>
            </div>
            ...
            <div class="col-12 col-md-6 mb-4 col-lg-3">
                <div class="card flip-card p-5 align-center">
                    <div class="card-front card_cont">
                        <img src="assets/images/template-porto-03-4.18.33-pm-copy-528x368.jpg" alt="Mobirise" title="">
                    </div>
                    <div class="card_back card_cont">
                        <h4 class="card-title py-2 mbr-fonts-style display-5">Coffee Lab</h4>
                        <p class="mbr-text mbr-fonts-style display-7">
            ...
            <div class="col-12 col-md-6 mb-4 col-lg-3">
                <div class="card flip-card p-5 align-center">
                    <div class="card-front card_cont">
                        <img src="assets/images/template-porto-01-4.18.33-pm-528x368.jpg" alt="Mobirise" title="">
                    </div>
                    <div class="card_back card_cont">
                        <h4 class="card-title py-2 mbr-fonts-style display-5">Kantong Tea</h4>
                        <p class="mbr-text mbr-fonts-style display-7">
            ...
            <div class="carousel-item">
                    <div class="user col-md-8">
                        <div class="user_image">
                            <img src="assets/images/mukak2-1-289x300.jpg" alt="" title="">
                        </div>
                        <div class="user_text pb-3">
                            <p class="mbr-fonts-style display-7">"We are group of passionate designers and developers who really love to create packaging for all of you"</p>
                        </div>
                        <div class="user_name mbr-bold pb-2 mbr-fonts-style display-7">Natalie Parametha</div>
                    ...
                    <div class="user col-md-8">
                        <div class="user_image">
                            <img src="assets/images/yoyoyoy2-01-1-279x300.jpg" alt="" title="">
                        </div>
                        <div class="user_text pb-3">
                            <p class="mbr-fonts-style display-7">"We are group of passionate designers and developers who really love to create packaging for all of you"</p>
                        </div>
                        <div class="user_name mbr-bold pb-2 mbr-fonts-style display-7">Natalie Parametha</div>
                        <div class="user_desk mbr-light mbr-fonts-style display-7">CEO &amp; Founder</div>
                    </div>
                </div></div>

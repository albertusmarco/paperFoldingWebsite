...
<br/>
<br/>
<h2 align="center">Upload Payment Receipt</h2>
<br/>
<p align="center">Choose your payment type : <select name="combobox_jurusan" size="1" id="combobox_jurusan"><option value="down_payment">Down Payment (DP)</option><option value="repayment">Repayment (Pelunasan)</option></select></p>
